...
export default function Desktop({setBorderWidth, borderWidth, categoryNumber, handlePoint, handleNext, number, next, submit, setSubmit, resultCategory, handleResultSet, result, setResult}) {
    let type = 'pc';
    return (
        <>
