        ...
        <>
            ...
            <Main>
                <div className={is + "-box"}>
                    <Title type={is} title="시험장 검색" icon={icon} contents="가까운 시험장을 검색해 보세요!"/>
                    <div className={is + "-input-create"}>
                        <input placeholder="가까운 시험장을 검색해 보세요." value={value} onChange={handleChange} onKeyDown={handleSubmit}/>
                        <button onClick={handleButtonSubmit}>&#62;</button>
                    </div>
                    <Map latitude={latitude} longitude={longitude} testSite={testSite} testSiteList={testSiteList}/>
